...
function factorial($x) { 
	...
	return $x;
/*По код стайлу: 
Если вы пишете условие if то все его составляющие (else и фигурные скобки) должны быть на одном уровне с ним */
} else {
...
/* По логике:
 Пробовали распечатать массив? Удобно пользоваться им? 
 */
